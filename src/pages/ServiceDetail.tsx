...
import { ChevronRight, PhoneCall, CheckCircle2, ChevronDown } from 'lucide-react';
  ...
  return (
    <>
      ...
      {!service || !brand ? (
        ...
        <>
          {/* Breadcrumb */}
          <div className="bg-slate-50 border-b border-slate-200 pt-32 pb-12 relative overflow-hidden">
            <div className="container mx-auto px-4 flex items-center text-[10px] font-black tracking-tight text-black overflow-x-auto relative z-10">
            ...
            {/* Scroll Down Arrow */}
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-30 text-slate-300/50 animate-bounce-slow">
