      ...
      {!product || !brand ? (
        ...
        <>
          ...
          <div className="bg-gray-50 border-b border-gray-200 pt-32 pb-4">
            <div className="container mx-auto px-4 max-w-7xl flex items-center text-[10px] font-black tracking-tight text-gray-400 overflow-x-auto">
          ...
          <div className="container mx-auto px-4 max-w-7xl py-20">
            ...
            <div className="flex flex-col lg:flex-row gap-20 mb-32">
              ...
              <div className="lg:w-1/2">
                ...
                <h1 className="text-3xl md:text-5xl font-extrabold text-black mb-10 leading-[0.95] tracking-tighter">
            ...
            <div className="bg-[#0f2851] p-16 rounded-[4rem] text-white shadow-2xl">
              <div className="flex flex-col md:flex-row justify-between items-end gap-10 mb-16">
                <div>
                  <div className="text-xs font-black text-slate-500 tracking-tight mb-6 flex items-center gap-6">
                ...
                {[
                  ...
                  <a key={i} href="#" className="group bg-white/5 border border-white/10 p-10 rounded-[2.5rem] hover:bg-white hover:text-black transition-all duration-500">
                    ...
                    <div className="flex items-center gap-3 text-[10px] font-black tracking-tight">
                      <span className="border-b border-white/20 group-hover:border-black/20 pb-1">Bu ürün için iletişime geçin</span>
