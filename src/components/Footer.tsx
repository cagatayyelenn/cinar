...
export default function Footer() {
  return (
    <footer 
      className="text-slate-400 pt-24 pb-12 font-sans overflow-hidden relative"
    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="lg:pr-12">
            <Link to="/" className="flex items-center gap-4 mb-8 group">
              ...
              <div className="flex flex-col">
                <span className="text-white font-black text-2xl leading-none">Çınar</span>
                <span className="text-amber-500 font-bold text-[10px]">Oto Klima</span>
              </div>
            </Link>
          ...
          {/* Col 2: Quick Links */}
          <div>
            <h3 className="text-white font-black text-xs mb-10">Hızlı bağlantılar</h3>
          ...
          <div>
            <h3 className="text-white font-black text-xs mb-10">Yetkili servisler</h3>
            <ul className="space-y-4">
              {brands.map(brand => (
                <li key={brand.id}>
          ...
          {/* Col 4: Services */}
          <div>
            <h3 className="text-sm font-black text-white mb-8">Hizmetlerimiz</h3>
            <ul className="space-y-4">
              {[
                'Klima Montajı',
                'Isıtıcı Sistemleri',
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row items-center justify-between pt-10 border-t border-white/5 text-[11px] font-bold text-slate-500">
          <p className="text-[10px] font-bold text-gray-500">
            &copy; {new Date().getFullYear()} Çınar oto klima. Tüm hakları saklıdır.
          </p>
