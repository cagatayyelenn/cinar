...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-[9999] w-full transition-all duration-300 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
      ...
      {/* Mobile Menu - Premium Slide-in with Portal */}
      {typeof document !== 'undefined' && createPortal(
        <div className={cn(
          "lg:hidden fixed inset-0 z-[99999] transition-all duration-500 overflow-hidden",
