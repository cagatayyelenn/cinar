...
export const products = [
  ...
  // Brand-Specific Network Services (New)
  { 
    id: 'akdeniz-klima-servis', 
    brandId: 'other', 
    name: 'Akdeniz Klima Servis', 
    image: '/hizmetler/akdeniz-klima.webp', 
    description: 'Akdeniz klima sistemleri için uzman teknik servis desteği. Ticari araç ve otobüs klimalarında periyodik bakım ve orijinal parça değişimi.',
  ...
  { 
    ...
    description: 'Albatros marka araç iklimlendirme sistemleriniz için profesyonel onarım ve bakım hizmetleri.',
  ...
  { 
    ...
    description: 'Astron araç klimalarında meydana gelen teknik sorunların hızlı ve kalıcı çözümü için Çınar Oto Klima uzmanlığına güvenin.',
  ...
  { 
    ...
    description: 'Coolertech park klimaları ve split sistemler için yetkili servis kalitesinde bakım, onarım ve yedek parça desteği.',
  ...
  { 
    ...
    description: 'Binek ve hafif ticari araçlarda kullanılan Delphi klima sistemleri ve kompresörleri için uzman onarım desteği.',
  ...
  { 
    ...
    description: 'Eurostar ticari araç iklimlendirme çözümlerinde periyodik bakım ve arıza giderme hizmetleri.',
  ...
  { 
    ...
    description: 'Konvekta otobüs ve raylı sistem klimaları için profesyonel teknik destek ve orijinal yedek parça hizmeti.',
  ...
  { 
    ...
    description: 'Safkar marka ticari araç soğutucu ve klimaları için yetkili servis hassasiyetinde hızlı onarım ve bakım.',
  ...
  { 
    ...
    description: 'Sütrak (Carrier) otobüs iklimlendirme sistemleri için dünya standartlarında bakım ve yedek parça desteği.',
